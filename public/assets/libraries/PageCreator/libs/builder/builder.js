...
Vvveb.Builder = {
    ...
    saveAjax2: function(fileName, startTemplateUrl, callback) {
        var data = {};
        data["fileName"] = (fileName && fileName != "") ? fileName : Vvveb.FileManager.getCurrentUrl();
        data["startTemplateUrl"] = startTemplateUrl;
        if (!startTemplateUrl || startTemplateUrl == null) {
        ...
        $.ajax({
            type: "POST",
            url: 'save2.php', //set your server side save script url
            data: data,
            cache: false,
            success: function(data) {
...
Vvveb.Gui = {
    ...
    saveAjax: function() {
        ...
        // var url = localStorage.getItem("botpath");

        return Vvveb.Builder.saveAjax(url, null, function(data) {
            $('#message-modal').modal().find(".modal-body").html("File saved at: " + localStorage.getItem("botpath"));
    ...
    saveAjax2: function() {
        ...
        return Vvveb.Builder.saveAjax(url, null, function(data) {
            $('#message-modal').modal().find(".modal-body").html("File saved at: " + localStorage.getItem("humanpath"));
