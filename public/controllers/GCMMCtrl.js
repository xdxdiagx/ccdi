...
angular.module('newApp').controller('GCMMCtrl', function ($scope) {
    $(document).ready(function () {
        var username = localStorage.getItem("username");

        var register = localStorage.getItem("register");

        var ref = firebase.database().ref("gcmm");
        ...
        $scope.mYear = function () {
            ...
            if (mYear == "2021") {
                ...
                var ref2 = firebase.database().ref("gcmm" + mYear);
                // console.log(year);
                ref2021.orderByChild("team").equalTo("gcmm").on("child_added", function (snapshot) {
        ...
        $scope.addData = function () {
            ...
            var ref2 = firebase.database().ref("/gcmm" + cYear);
            var ref3 = firebase.database().ref("/gcmm" + (cYear - 1));
