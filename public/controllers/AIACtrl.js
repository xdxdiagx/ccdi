...
angular.module('newApp').controller('AIACtrl', function ($scope) {
    $(document).ready(function () {
        var username = localStorage.getItem("username");

        var register = localStorage.getItem("register");

        var ref = firebase.database().ref("aia");
        ...
        $scope.mYear = function () {
            ...
            if (mYear == "2021") {
                ...
                var ref2 = firebase.database().ref("aia" + mYear);
                // console.log(year);
        ...
        // ref.orderByChild("evangelism").on("value", function (snapshot) {
        ...
        $scope.addData = function () {
            ...
            var ref2 = firebase.database().ref("/aia" + cYear);
            var ref3 = firebase.database().ref("/aia" + (cYear - 1));
