...
angular.module('newApp').controller('JFCtrl', function ($scope) {
    $(document).ready(function () {
        var username = localStorage.getItem("username");

        var register = localStorage.getItem("register");

        var ref = firebase.database().ref("jf");
        ...
        $scope.mYear = function () {
            ...
            if (mYear == "2021") {
                ...
                var ref2 = firebase.database().ref("jf" + mYear);
                // console.log(year);
                ref2021.orderByChild("team").equalTo("jf").on("child_added", function (snapshot) {
        ...
        $scope.addData = function () {
            ...
            var ref2 = firebase.database().ref("/jf" + cYear);
            var ref3 = firebase.database().ref("/jf" + (cYear - 1));
