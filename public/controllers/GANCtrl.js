...
angular.module('newApp').controller('GANCtrl', function ($scope) {
    $(document).ready(function () {
        var username = localStorage.getItem("username");

        var register = localStorage.getItem("register");

        var ref = firebase.database().ref("gan");
        ...
        $scope.mYear = function () {
            ...
            if (mYear == "2021") {
                ...
                var ref2 = firebase.database().ref("gan" + mYear);
                // console.log(year);
                ref2021.orderByChild("team").equalTo("gan").on("child_added", function (snapshot) {
        ...
        $scope.addData = function () {
            ...
            var ref2 = firebase.database().ref("/gan" + cYear);
            var ref3 = firebase.database().ref("/gan" + (cYear - 1));
