...
angular.module('newApp').controller('R8Ctrl', function ($scope) {
    $(document).ready(function () {
        var username = localStorage.getItem("username");

        var register = localStorage.getItem("register");

        var ref = firebase.database().ref("r8");
        ...
        $scope.mYear = function () {
            ...
            if (mYear == "2021") {
                ...
                console.log(year);
                ref2021.orderByChild("team").equalTo("r8").on("child_added", function (snapshot) {
        ...
        $scope.addData = function () {
            ...
            var ref2 = firebase.database().ref("/r8" + cYear);
            var ref3 = firebase.database().ref("/r8" + (cYear - 1));
